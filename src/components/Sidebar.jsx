      ...
      <div className={SIDEBAR_CLASSES.desktop}>
        <div className="p-5 border-b border-red-100 lg:block hidden">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-amber-300 to-red-500 flex items-center justify-center text-white font-bold shadow-md">
              {initial}
            </div>
            <div className="">
        ...
        <div className="p-4 space-y-6 overflow-y-auto flex-1">
          ...
          <div className="mt-20 pt-6 lg:block hidden">
            <div className={TIP_CARD.container}>
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className={TIP_CARD.text}>Start early, and momentum will carry you to the finish.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="fixed inset-0 z-40">
          ...
          >
            <div className="flex justify-between items-center mb-4 border-b pb-2">
              ...
              <button onClick={() => setMobileOpen(false)} className="text-gray-700 hover:text-red-500">
                <X className="w-5 h-5" />
              </button>
            </div>
